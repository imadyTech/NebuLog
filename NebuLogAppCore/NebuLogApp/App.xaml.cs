...
namespace NebuLogApp
{
    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            //this.Configure(services, factory);//2020-09-14 实际上没有使用loggerfactory.UseNebuLogWpf()来获取logger实例
            ...
            logger.Log<App>(LogLevel.Information, new EventId(0, ""), this, null, (app, e)=> "NebuLogApp");
        ...
        public void Configure(IServiceCollection services, ILoggerFactory loggerFactory)
        {
            ...
            //loggerFactory.UseNebuLogWpf(GetConnection());
        }
